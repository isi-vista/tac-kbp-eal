...
public final class CorefAnnotation {
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equal(this.docId, other.docId) && Objects.equal(this.idToCASes, other.idToCASes)
        && Objects.equal(this.CASesToIDs, other.CASesToIDs) && Objects
        .equal(this.unannotated, other.unannotated);
  }
  ...
  /**
   * Returns the normalization of a {@link com.bbn.kbp.events2014.KBPString} to some canonical
   ...
   * If a provided {@code KBPString} has no coreference information, a {@link
  ...
  public static final class Builder {
    ...
    public Builder addUnannotatedCAS(KBPString cas) {
      ...
      if (!CASesToIDsMutable.containsKey(cas)) {
        ...
        log.warn("CAS " + cas.toString()
            + " may not be both annotated and unannotated for coref. Treating as annotated.");
      }
      return this;
    }
