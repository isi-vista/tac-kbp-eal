    ...
    return ImmutableList.<BootstrapInspector.SummaryAggregator<LinkingScoreDocRecord>>of(
        new BootstrapInspector.SummaryAggregator<LinkingScoreDocRecord>() {
          ...
          public void observeSample(
            ...
            f1sB.put("Aggregate", (linkNormalizerSum > 0.0) ? 100.0*f1 / linkNormalizerSum : 0.0);
            precisionsB.put("Aggregate",
                (linkNormalizerSum > 0.0) ? 100.0*precision / linkNormalizerSum : 0.0);
            recallsB
                .put("Aggregate", (linkNormalizerSum > 0.0) ? 100.0*recall / linkNormalizerSum : 0.0);
          }
